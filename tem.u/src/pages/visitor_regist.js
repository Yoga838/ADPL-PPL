    ...
    <div>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="my-5  col-md-6 ms-5 pb-5">
              <h4 className="poppins mt-4">
                Selamat Datang
              </h4>
              <h1 className="poppins fw-bold">Segera Daftarkan Diri Anda</h1>
              <div className="button mt-3">
                <Link href="mitra_regist"><button className="  poppins btn rounded-pill ps-4 pe-4 text-color-yellow shadow"  role="button">Mitra</button></Link>
                <a className="text-white poppins btn ms-2 bg-color-yellow  rounded-pill ps-4 pe-4 shadow " href="#" role="button">User</a>
              </div>
              <form onSubmit={doregister}>
                ...
                <div className="input-Email mt-2">
                  ...
                  <input type="Text" id="inputEmail"  className="width-form-2 rounded1 form-control" value={email} onChange={(e) => setEmail(e.target.value)} />
                </div> 
                <div className="input-Password mt-2">
                  <label htmlFor="inputPassword" className="poppins form-label">Password</label>
                  <input type="Text" id="inputPassword"  className="width-form-2 rounded1 form-control" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
